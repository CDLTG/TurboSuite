...
## TurboTape
TurboTape is comprised of five subroutines which allow the user to construct any linear object using TurboTape. While this can also be achieved using dynamic blocks, TurboTape automatically names each block independently so that it can be used in conjunction with the counts sheet.
